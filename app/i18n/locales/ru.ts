export default {
  ...
  marketplace: {
    ...
    submitAdPage: {
      ...
      selectCategoryTitle: "Выбор категории",
      ...
      condition: "Состояние",
      selectConditionTitle: "Выбор состояния",
      selectConditionMessage: "Выберите состояние товара",
      ...
      mediaPermissionRequired:
        "Нам нужен доступ к вашим фотографиям для загрузки изображений",
      formError: "Ошибка формы",
      productNameTooShort:
        "Название товара должно содержать не менее 10 символов",
      ...
      adSubmitted: "Объявление опубликовано",
      adSubmittedSuccess: "Ваше объявление успешно опубликовано",
      adSubmitFailed:
