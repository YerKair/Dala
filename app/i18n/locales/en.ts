export default {
  ...
  marketplace: {
    ...
    submitAdPage: {
      ...
      mediaPermissionRequired: "We need access to your photos to upload images",
      ...
      adSubmittedSuccess: "Your ad has been successfully submitted",
      adSubmitFailed: "Failed to submit ad. Please try again.",
